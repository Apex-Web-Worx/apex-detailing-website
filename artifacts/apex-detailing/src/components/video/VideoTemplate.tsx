...
// Colors: #3496FF (Blue), #A886CD (Purple)
    ...
    <div className="relative w-full h-screen overflow-hidden bg-zinc-950 font-sans text-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div 
          ...
          style={{ background: 'radial-gradient(circle, #3496FF, transparent 70%)' }}
          animate={{ 
            x: ['-20%', '30%', '-10%', '-20%'], 
            y: ['-20%', '10%', '40%', '-20%'],
            scale: [1, 1.2, 0.9, 1] 
        ...
        <motion.div 
          ...
          style={{ background: 'radial-gradient(circle, #A886CD, transparent 70%)' }}
          animate={{ 
            x: ['40%', '10%', '60%', '40%'], 
            y: ['60%', '20%', '-10%', '60%'],
            scale: [0.8, 1.1, 1, 0.8] 
