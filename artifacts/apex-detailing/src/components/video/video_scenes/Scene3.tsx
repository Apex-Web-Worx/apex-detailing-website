  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 right-12 md:right-24 flex flex-col justify-center items-end text-right max-w-2xl">
        <motion.div
          className="h-1 w-24 bg-gradient-to-l from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] mb-8"
        ...
        <div className="overflow-hidden mb-6">
          <motion.h2 
            className="text-5xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-l from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] leading-tight"
            initial={{ y: "100%" }}
