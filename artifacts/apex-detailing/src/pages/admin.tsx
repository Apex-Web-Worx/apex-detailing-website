    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4">
      ...
      >
        <input
          ...
          style={{ display: "none" }}
        />
        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] flex items-center justify-center mx-auto mb-6">
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition mb-4"
        />
        {error && (
        ...
        <button
          ...
          className="w-full px-6 py-3 rounded-full bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold disabled:opacity-50 hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2"
        >
          ...
          >
            <div className="mb-4 flex flex-wrap items-center gap-2 rounded-xl border border-white/10 bg-white/[0.02] p-3">
              ...
              <input
                ...
                className="bg-white/5 border border-white/10 rounded-lg px-3 py-1.5 text-sm text-white focus:outline-none focus:border-[#5ECFFF]"
    ...
    <section className="mt-12 pt-8 border-t border-white/10">
      ...
      >
        <input
          ...
          min={today}
          required
          className="px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition text-white"
        />
        <input
          type="text"
          value={reason}
          ...
          maxLength={200}
          className="flex-1 px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition text-white placeholder:text-gray-500"
        />
        <button
          type="submit"
          disabled={!date || submitting}
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold disabled:opacity-50 hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2 whitespace-nowrap"
        >
          {submitting ? (
    ...
    <section className="mt-12 pt-8 border-t border-white/10">
      ...
      >
        <select
          ...
          className="px-3 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 text-white focus:border-[#5ECFFF] focus:outline-none"
          required
        >
        ...
        <input
          ...
          className="px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 text-white placeholder:text-gray-500 focus:border-[#5ECFFF] focus:outline-none"
        />
        <button
          type="submit"
    ...
    <div className={`p-4 ${rule.active ? "" : "opacity-50"}`}>
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        {rule.slots.map((s) => (
          ...
          >
            <Clock className="w-3 h-3 text-[#5ECFFF]" />
        ...
        <input
          ...
          className="bg-white/[0.04] border border-white/10 rounded-full px-3 py-1 text-xs text-white focus:border-[#5ECFFF] focus:outline-none"
        />
        <button
          onClick={() => {
            if (!newTime) return;
    ...
    <div
      className={`rounded-2xl border p-5 ${
        muted
          ...
          : "border-white/10 bg-white/[0.03] hover:border-[#5ECFFF]/30 transition"
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-[#5ECFFF] font-bold text-sm mb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-400">
            ...
            <a
              ...
              className="flex items-center gap-2 hover:text-[#5ECFFF]"
            >
        ...
        {(onEdit || onCancel) && (
          <div className="flex items-center gap-2 self-start">
            {onEdit && (
              <button
                onClick={onEdit}
                className="flex items-center gap-1.5 text-xs text-[#5ECFFF] hover:text-white hover:bg-[#5ECFFF]/10 px-3 py-1.5 rounded-lg border border-[#5ECFFF]/30 transition"
              >
    ...
    <form onSubmit={submit} className="space-y-4">
      <Field label="Customer name">
        <input
          ...
          required
          className="w-full px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition"
        />
      </Field>
      ...
      <Field label="Notes">
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition resize-none"
        />
      </Field>
      ...
      <div className="flex justify-end gap-3 pt-2">
        <button
          ...
          className="px-6 py-2.5 rounded-full bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold disabled:opacity-30 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2"
        >
          {submitting ? (
            <>
