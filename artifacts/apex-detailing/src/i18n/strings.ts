...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "hero.desk1": "Unleash",
    "hero.desk2": "Your Car's",
    "hero.desk3": "True Potential",
    "hero.subtitleLead": "Premium auto detailing, ceramic coating,",
    "hero.subtitleRest": "and paint correction services serving",
  ...
  ru: {
    ...
    "hero.desk1": "Раскройте",
    "hero.desk2": "настоящий потенциал",
    "hero.desk3": "авто",
