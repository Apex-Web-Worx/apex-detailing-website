          ...
          <div className="hidden md:flex items-center justify-end gap-2 lg:gap-2.5 xl:gap-3 min-w-0 flex-1">
            ...
            {links.map((link) => {
              const secondary =
                ...
                link.id === "journal" ||
                link.id === "gift" ||
                link.id === "testimonials";
              return (
                <a
                  key={link.id}
                  href={link.href}
                  className={`group relative text-[11px] lg:text-xs font-semibold uppercase tracking-wide text-gray-300 transition-colors hover:text-white whitespace-nowrap shrink-0 ${
