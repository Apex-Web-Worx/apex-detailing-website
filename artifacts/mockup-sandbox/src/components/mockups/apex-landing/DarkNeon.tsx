          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 text-gray-400 font-light text-lg">
                <p>
                  Apex Detailing operates at the intersection of technology and artistry. We don't just clean vehicles; we engineer perfection. Serving Nixa <span className="location-separator">—</span> Ozark <span className="location-separator">—</span> Springfield with uncompromising quality.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 font-light max-w-sm mb-8">
                Prestige vehicle detailing services for those who demand absolute perfection in Nixa <span className="location-separator">—</span> Ozark <span className="location-separator">—</span> Springfield.
              </p>
