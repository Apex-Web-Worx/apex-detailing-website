...
function GiftCardVisual({ amount }: { amount: number | string }) {
  return (
    <div className="relative w-full max-w-sm mx-auto aspect-[1.6/1] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
      <div className="absolute inset-0 bg-gradient-to-br from-[#FF1AD8] via-[#6b5aa8] to-[#00F0FF]" />
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <header className="border-b border-white/10 bg-[#0a0a0a]/95 backdrop-blur sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1 text-sm font-bold text-[#00F0FF] hover:text-white transition"
          >
      ...
      <section className="relative overflow-hidden py-16 sm:py-24">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[500px] bg-gradient-to-b from-[#FF1AD8]/20 to-[#00F0FF]/10 blur-3xl pointer-events-none" />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -z-10 inset-0 blur-3xl bg-gradient-to-br from-[#FF1AD8]/30 to-[#00F0FF]/30" />
            </div>
          </div>
        </div>
      </section>
              ...
              return (
                <a
                  ...
                  className={`group relative flex flex-col p-6 sm:p-7 rounded-2xl border transition hover:-translate-y-1 hover:shadow-2xl ${
                    isPopular
                      ? "border-[#00F0FF]/50 bg-gradient-to-br from-[#00F0FF]/[0.08] via-transparent to-[#FF1AD8]/[0.06]"
                      : "border-white/10 bg-white/[0.02] hover:border-[#00F0FF]/40"
                  }`}
                >
                  {pkg.badge && (
                    <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-gradient-to-r from-[#FF1AD8] to-[#00F0FF] text-white whitespace-nowrap">
                      <Star
                  ...
                  <p className="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-[#FF1AD8] to-[#00F0FF] mb-1 leading-none">
                    ${pkg.amount}
                  </p>
                  ...
                  <div
                    className={`w-full text-center py-3 rounded-xl font-black text-sm uppercase tracking-wider transition ${
                      isPopular
                        ? "bg-gradient-to-r from-[#FF1AD8] to-[#00F0FF] text-white"
                        : "bg-white/5 text-white border border-white/10 group-hover:border-[#00F0FF] group-hover:bg-[#00F0FF]/10"
                    }`}
                  >
          ...
          <div className="max-w-2xl mx-auto mt-10 p-6 sm:p-8 rounded-2xl border border-white/10 bg-white/[0.02]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-end">
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#0a0a0a] border border-white/10 text-2xl font-black focus:outline-none focus:border-[#00F0FF] transition"
                  />
                </div>
              ...
              <a
                ...
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#FF1AD8] to-[#00F0FF] text-white font-black uppercase tracking-wider text-sm text-center hover:shadow-lg hover:shadow-[#00F0FF]/30 transition whitespace-nowrap"
              >
                Continue to Checkout →
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              return (
                ...
                >
                  <div className="absolute -top-4 -left-4 w-10 h-10 rounded-full bg-gradient-to-br from-[#FF1AD8] to-[#00F0FF] flex items-center justify-center font-black text-white">
                    {item.step}
                  </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative max-w-4xl mx-auto rounded-3xl overflow-hidden border border-white/10 bg-[#111] p-10 sm:p-16 text-center">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-full bg-gradient-to-b from-[#FF1AD8]/20 to-[#00F0FF]/20 blur-3xl pointer-events-none" />
            <div className="relative">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-[#FF1AD8] to-[#00F0FF] text-white font-black uppercase tracking-wider hover:shadow-2xl hover:shadow-[#00F0FF]/30 transition"
              >
