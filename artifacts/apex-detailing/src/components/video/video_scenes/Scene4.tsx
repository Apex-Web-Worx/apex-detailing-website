  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        <motion.div
          className="w-[1px] h-24 bg-gradient-to-b from-transparent via-[#00F0FF] to-transparent mb-8"
          initial={{ scaleY: 0 }}
        ...
        <div className="overflow-hidden mb-6">
          <motion.h2 
            className="text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#00F0FF] to-[#FF1AD8] tracking-widest"
            initial={{ y: "100%" }}
