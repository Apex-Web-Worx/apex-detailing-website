    ...
    description: (
      <>
        ...
        <span className="text-[#FFA500] font-bold">
          Please note: Heavily soiled interiors, stains, excessive pet hair, or deep cleaning needs may require a Full Interior Detail. Final service type will be confirmed upon inspection.
        </span>
      </>
    ),
    icon: <Droplets className="w-10 h-10 text-[#A886CD]" />,
...
const gallery = [
  ...
  { id: 3, title: "Interior Restoration", beforeAfter: true, color: "from-blue-900 to-indigo-900", thumbnail: `${import.meta.env.BASE_URL}images/interior-restoration-video.mp4`, images: [
    { src: `${import.meta.env.BASE_URL}images/IMG_1290_1775780654764.jpeg`, label: "Before" },
    { src: `${import.meta.env.BASE_URL}images/IMG_1303_1775780654764.jpeg`, label: "After" },
    { src: `${import.meta.env.BASE_URL}images/IMG_1297_1775780654765.jpeg`, label: "Before" },
    { src: `${import.meta.env.BASE_URL}images/IMG_1309_1775780654765.jpeg`, label: "After" },
    { src: `${import.meta.env.BASE_URL}images/IMG_1294_1775780654765.jpeg`, label: "Before" },
    { src: `${import.meta.env.BASE_URL}images/IMG_1306_1775780654765.jpeg`, label: "After" },
  ], currentImageIndex: 0 },
