        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#A886CD]/10 to-[#3496FF]/10 border border-[#A886CD]/30 backdrop-blur-sm mb-8">
            ...
            <span className="text-sm font-bold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#A886CD] to-[#3496FF] uppercase">
              Nixa <span className="location-separator">—</span> Ozark <span className="location-separator">—</span> Springfield Premium Detailing
            </span>
          </div>
          ...
          <p className="max-w-2xl text-lg md:text-xl text-gray-300 mb-10 font-medium">
            ...
            <span className="text-[#3496FF] font-bold"> Nixa <span className="location-separator">—</span> Ozark <span className="location-separator">—</span> Springfield</span>. We bring the showroom shine to your vehicle.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-gray-400 text-lg mb-10">
                <p>
                  Where passion, precision, and purpose come together to serve you with excellence. Serving the Nixa <span className="location-separator">—</span> Ozark <span className="location-separator">—</span> Springfield areas, we specialize in high-quality car detailing that restores beauty, protects value, and reflects the pride you have in your vehicle.
                </p>
                <p>
