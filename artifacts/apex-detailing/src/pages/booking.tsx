...
const SERVICE_ICONS: Record<string, { icon: typeof Wand2; color: string }> = {
  ...
  "apex-exterior-detailing": { icon: Car, color: "text-[#5ECFFF]" },
  "apex-wash-clay-wax": { icon: Sparkles, color: "text-[#FF1AD8]" },
  "apex-headlight-restoration": { icon: CheckCircle2, color: "text-[#5ECFFF]" },
  "apex-ceramic-coating": { icon: Shield, color: "text-[#5ECFFF]" },
                  ...
                  <div className="flex flex-col items-center gap-2 flex-shrink-0">
                    <div
                      className={`w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold border-2 transition ${
                        active
                          ? "bg-gradient-to-br from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] border-transparent text-white"
                          : done
                            ? "bg-[#5ECFFF]/20 border-[#5ECFFF] text-[#5ECFFF]"
                    ...
                    <span
                      className={`text-[10px] sm:text-xs font-bold uppercase tracking-wide ${
                        active ? "text-white" : done ? "text-[#5ECFFF]" : "text-gray-500"
                      }`}
                    >
                      {s.label}
                    </span>
      ...
      <footer className="border-t border-white/10 bg-[#0a0a0a] mt-8">
        <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          <div className="flex items-center gap-2 text-center sm:text-left">
            ...
            <a
              href="tel:417-527-6165"
              className="text-[#5ECFFF] font-semibold hover:underline"
            >
              417-527-6165
            </a>
          ...
          return (
            <button
              ...
              className={`relative text-left p-6 rounded-2xl border transition group hover:-translate-y-0.5 hover:shadow-2xl ${
                isSelected
                  ? "border-[#5ECFFF] bg-gradient-to-br from-[#5ECFFF]/10 to-[#FF1AD8]/5"
                  : isPopular
                    ? "border-[#FF1AD8]/50 bg-gradient-to-br from-[#FF1AD8]/[0.06] to-transparent hover:border-[#FF1AD8]"
                    : "border-white/10 bg-white/[0.02] hover:border-[#5ECFFF]/40"
              }`}
            >
                  ...
                  {badge && (
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider text-white ${
                        badge.tone === "popular"
                          ? "bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF]"
                          : badge.tone === "value"
                            ? "bg-[#5ECFFF]"
                            : badge.tone === "notice"
                              ? "bg-amber-500"
              ...
              <div className="flex items-baseline gap-2 mb-3 flex-wrap">
                {s.priceCents > 0 ? (
                  <>
                    ...
                    <span className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] font-display">
                      {formatPrice(s.priceCents)}
                    </span>
                  </>
                ) : (
                  <span className="text-base font-black bg-clip-text text-transparent bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF]">
                    Call for quote
                  </span>
                )}
              ...
              <div className="flex items-center gap-3 text-xs text-gray-500">
                <span className="text-[#5ECFFF] font-bold flex items-center gap-1 ml-auto opacity-0 group-hover:opacity-100 transition">
    ...
    <section>
              ...
              return (
                <button
                  ...
                  className={`p-3 rounded-xl text-center transition ${
                    isPicked
                      ? "bg-gradient-to-br from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white"
                      : disabled
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4 sm:p-6 mb-6">
          ...
          {selectedDay.slots.every((s) => !s.available) && (
            <p className="text-sm text-gray-400 mt-4">
              ...
              <a href="tel:417-527-6165" className="text-[#5ECFFF] underline">
                417-527-6165
              </a>
              .
            </p>
      ...
      <div className="flex justify-end">
        <button
          ...
          className="px-8 py-3 clip-chamfer bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold tracking-[0.08em] uppercase disabled:opacity-30 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center gap-2"
        >
    ...
    <section>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition resize-none"
          />
        </div>
      </div>
      ...
      >
        <input
          ...
          className="mt-1 w-5 h-5 accent-[#5ECFFF] flex-shrink-0 cursor-pointer"
        />
        <span className="text-xs text-gray-400 leading-relaxed">
          ...
          <Link href="/privacy" className="text-[#5ECFFF] hover:underline">
            Privacy Policy
          </Link>{" "}
          and{" "}
          <Link href="/terms" className="text-[#5ECFFF] hover:underline">
            Terms &amp; Conditions
          </Link>
          .
        </span>
...
function Field({
  ...
  return (
    <div>
      <label className="block text-sm font-bold text-gray-300 mb-2">
        {label}
        {required && <span className="text-[#5ECFFF] ml-1">*</span>}
      </label>
      <input
        type={type}
        value={value}
        ...
        className="w-full px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 focus:border-[#5ECFFF] focus:outline-none focus:ring-2 focus:ring-[#5ECFFF]/20 transition"
      />
    </div>
  );
}
...
function ConfirmStep({
  ...
  return (
    <section>
      ...
      <div className="mt-6 p-4 rounded-xl bg-[#5ECFFF]/5 border border-[#5ECFFF]/20 text-sm text-gray-300 flex gap-3">
        <MapPin className="w-5 h-5 text-[#5ECFFF] flex-shrink-0 mt-0.5" />
        <div>
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-3 mt-8">
        ...
        <button
          ...
          onClick={submit}
          className="px-8 py-3 clip-chamfer bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold tracking-[0.08em] uppercase disabled:opacity-50 hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2"
        >
          {mutation.isPending ? (
            <>
    ...
    <div className="flex items-start justify-between gap-4 px-5 py-4">
      ...
      <span
        className={`text-right font-semibold ${
          highlight
            ? "text-xl bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] bg-clip-text text-transparent"
            : "text-white"
        }`}
      >
        {value}
...
function ConfirmationView({ booking }: { booking: Booking }) {
  return (
    <section className="text-center max-w-2xl mx-auto pt-12">
      <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] flex items-center justify-center mb-6 shadow-2xl shadow-[#5ECFFF]/30">
      ...
      <div className="p-4 rounded-xl bg-[#5ECFFF]/5 border border-[#5ECFFF]/20 text-sm text-gray-300 flex gap-3 text-left mb-8">
        <MapPin className="w-5 h-5 text-[#5ECFFF] flex-shrink-0 mt-0.5" />
        <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a
          href="tel:417-527-6165"
          className="px-6 py-3 clip-chamfer bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold tracking-[0.08em] uppercase hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2"
        >
