          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 text-white/70 font-light text-lg mb-12">
                ...
                <p>
                  Serving Springfield / Nixa / Ozark, we bring unparalleled convenience without compromising on quality. Our mobile service delivers a studio-grade detailing experience directly to your driveway.
                </p>
              </div>
