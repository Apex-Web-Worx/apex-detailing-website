          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 text-white/70 font-light text-lg mb-12">
                ...
                <p>
                  Serving Nixa Ozark Springfield, MO, we bring unparalleled convenience without compromising on quality. Our mobile service delivers a studio-grade detailing experience directly to your driveway.
                </p>
              </div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href={CALENDLY_LINK} target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-[#D4A853] text-sm flex items-center gap-3 transition-colors">
                    ...
                    Mobile Service: Nixa Ozark Springfield, MO
                  </a>
                </li>
                <li>
