      ...
      {selectedGalleryItem && (
        ...
        >
          ...
          <button
            ...
            className="absolute top-4 right-4 md:top-6 md:right-6 text-white hover:text-[#3496FF] transition-colors z-10 p-1 flex-shrink-0 w-10 h-10 flex items-center justify-center"
