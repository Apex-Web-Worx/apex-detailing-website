...
export default function HeldAppointmentRow({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-[#0B0B0B] px-3 py-3 md:px-4">
      <div className="flex items-start md:items-center gap-3">
        <button
          type="button"
          onClick={() => openEditBlockedDate(hold)}
          className="flex-1 min-w-0 text-left touch-manipulation md:flex md:items-center md:gap-4"
        >
