  ...
  return (
    <section className="text-center max-w-xl mx-auto pt-12">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <a
          href="tel:417-527-6165"
          className="px-6 py-3 rounded-full bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold flex items-center justify-center gap-2"
        >
  ...
  return (
    <section>
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#5ECFFF]/10 border border-[#5ECFFF]/30 text-[#5ECFFF] text-xs font-bold uppercase tracking-wider mb-4">
          {isCancelled ? (
            <>
      ...
      <div className="p-4 rounded-xl bg-[#5ECFFF]/5 border border-[#5ECFFF]/20 text-sm text-gray-300 flex gap-3 mb-8">
      ...
      {locked ? (
        <div className="p-5 rounded-xl bg-white/[0.02] border border-white/10 text-center text-gray-400">
          ...
          <div className="mt-4">
            <Link
              href="/book"
              className="inline-block px-6 py-3 rounded-full bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition"
            >
              Book again
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button
            ...
            className="px-6 py-4 rounded-xl bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2"
          >
  ...
  return (
    <section className="text-center max-w-xl mx-auto pt-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <Link
          href="/book"
          className="px-6 py-3 rounded-full bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition"
        >
          Book another time
        </Link>
        <Link
    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-end">
        ...
        <button
          ...
          className="px-6 py-3 rounded-full bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] text-white font-bold disabled:opacity-30 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-[#5ECFFF]/30 transition flex items-center justify-center gap-2"
        >
          {mutation.isPending ? (
            <>
...
function RescheduledView({ booking }: { booking: Booking }) {
  ...
  return (
    <section className="text-center max-w-xl mx-auto pt-8">
      <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] flex items-center justify-center mb-6 shadow-2xl shadow-[#5ECFFF]/30">
        <Check className="w-8 h-8 text-white" />
      </div>
    ...
    <div className="flex items-start justify-between gap-4 px-5 py-4">
      ...
      <span
        className={`text-right font-semibold ${
          highlight
            ? "text-lg bg-gradient-to-r from-[#C9B0F5] via-[#A8B8FF] to-[#5ECFFF] bg-clip-text text-transparent"
            : "text-white"
        }`}
      >
        {value}
