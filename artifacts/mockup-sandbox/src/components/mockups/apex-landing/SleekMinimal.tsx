      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center mt-12">
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8">
            ...
            <span className="text-xs font-medium tracking-[0.15em] text-white/80 uppercase">Premium Vehicle Detailing in Nixa Ozark Springfield, MO</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-white/60 font-light max-w-2xl mb-12 leading-relaxed">
            Elevating automotive care in Nixa Ozark Springfield, MO. Experience meticulous craftsmanship and uncompromising quality.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-white/60 font-light text-lg leading-relaxed">
                ...
                <p>
                  Serving the Nixa Ozark Springfield, MO areas, we bring premium detailing services directly to you. Whether it's removing years of swirl marks or applying a 5-year ceramic coating, our methodical approach ensures perfection.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            <div>
              ...
              <p className="text-white/50 text-sm font-light leading-relaxed mb-8 max-w-xs">
                Premium automotive detailing services for those who demand excellence in the Nixa Ozark Springfield, MO areas.
              </p>
