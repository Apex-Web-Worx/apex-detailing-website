...
function GiftCardVisual({ amount }: { amount: number | string }) {
  return (
    <div className="relative w-full max-w-sm mx-auto aspect-[1.6/1] rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
      <div className="absolute inset-0 bg-gradient-to-br from-[#A886CD] via-[#6b5aa8] to-[#3496FF]" />
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <header className="border-b border-white/10 bg-[#0a0a0a]/95 backdrop-blur sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1 text-sm font-bold text-[#3496FF] hover:text-white transition"
          >
      ...
      <section className="relative overflow-hidden py-16 sm:py-24">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[500px] bg-gradient-to-b from-[#A886CD]/20 to-[#3496FF]/10 blur-3xl pointer-events-none" />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#A886CD]/10 border border-[#A886CD]/30 mb-5">
                <Gift className="w-4 h-4 text-[#A886CD]" />
                <span className="text-xs font-bold tracking-widest uppercase text-[#A886CD]">
                  Gift Cards
                </span>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-5 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-[#3496FF]" />
                  <span>Delivered instantly</span>
                </div>
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-[#A886CD]" />
                  <span>Never expires</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star
                    className="w-4 h-4 text-[#3496FF]"
                    fill="currentColor"
                  />
            ...
            <div className="relative">
              ...
              <div className="absolute -z-10 inset-0 blur-3xl bg-gradient-to-br from-[#A886CD]/30 to-[#3496FF]/30" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                <a
                  ...
                  className={`group relative flex flex-col p-6 sm:p-7 rounded-2xl border transition hover:-translate-y-1 hover:shadow-2xl ${
                    isPopular
                      ? "border-[#3496FF]/50 bg-gradient-to-br from-[#3496FF]/[0.08] via-transparent to-[#A886CD]/[0.06]"
                      : "border-white/10 bg-white/[0.02] hover:border-[#3496FF]/40"
                  }`}
                >
                  {pkg.badge && (
                    <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-gradient-to-r from-[#A886CD] to-[#3496FF] text-white whitespace-nowrap">
                      <Star
                  ...
                  <ul className="space-y-2 mb-6 flex-1">
                    {pkg.includes.map((line, i) => (
                      ...
                      >
                        <ChevronRight className="w-4 h-4 text-[#3496FF] shrink-0 mt-0.5" />
                        <span>{line}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <div
                    className={`w-full text-center py-3 rounded-xl font-black text-sm uppercase tracking-wider transition ${
                      isPopular
                        ? "bg-gradient-to-r from-[#A886CD] to-[#3496FF] text-white"
                        : "bg-white/5 text-white border border-white/10 group-hover:border-[#3496FF] group-hover:bg-[#3496FF]/10"
                    }`}
                  >
          ...
          <div className="max-w-2xl mx-auto mt-10 p-6 sm:p-8 rounded-2xl border border-white/10 bg-white/[0.02]">
            <div className="flex items-center gap-3 mb-4">
              <CreditCard className="w-5 h-5 text-[#A886CD]" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-end">
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#0a0a0a] border border-white/10 text-2xl font-black focus:outline-none focus:border-[#3496FF] transition"
                  />
                </div>
              ...
              <a
                ...
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#A886CD] to-[#3496FF] text-white font-black uppercase tracking-wider text-sm text-center hover:shadow-lg hover:shadow-[#3496FF]/30 transition whitespace-nowrap"
              >
                Continue to Checkout →
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              return (
                ...
                >
                  <div className="absolute -top-4 -left-4 w-10 h-10 rounded-full bg-gradient-to-br from-[#A886CD] to-[#3496FF] flex items-center justify-center font-black text-white">
                    {item.step}
                  </div>
                  <Icon className="w-8 h-8 text-[#A886CD] mb-4" />
      ...
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative max-w-4xl mx-auto rounded-3xl overflow-hidden border border-white/10 bg-[#111] p-10 sm:p-16 text-center">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-full bg-gradient-to-b from-[#A886CD]/20 to-[#3496FF]/20 blur-3xl pointer-events-none" />
            <div className="relative">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-[#A886CD] to-[#3496FF] text-white font-black uppercase tracking-wider hover:shadow-2xl hover:shadow-[#3496FF]/30 transition"
              >
