...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "pkg.interior.price.2": "3-row: $300",
    ...
    "pkg.interior.tier.2.amount": "$300",
    ...
    "pkg.wax.tier.0.amount": "$250",
    "pkg.wax.tier.1.label": "SUV",
    "pkg.wax.tier.1.amount": "$300–$350",
  ...
  ru: {
    ...
    "pkg.interior.price.1": "SUV / Jeep: $250",
    "pkg.interior.price.2": "3 ряда: $300",
