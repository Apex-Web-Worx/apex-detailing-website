...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "book.chooseSubMobile": "Tap a service to select it, then tap again to continue.",
  ...
  ru: {
    ...
    "book.chooseSubMobile": "Нажмите услугу, чтобы выбрать, затем нажмите ещё раз — далее.",
