      ...
      <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <p className="max-w-2xl text-lg md:text-xl text-gray-300 mb-10 font-medium">
            ...
            <span className="text-[#3496FF] font-bold"> Springfield / Nixa / Ozark</span>. We bring the showroom shine to your vehicle.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-gray-400 text-lg mb-10">
                <p>
                  Where passion, precision, and purpose come together to serve you with excellence. Serving the Springfield / Nixa / Ozark areas, we specialize in high-quality car detailing that restores beauty, protects value, and reflects the pride you have in your vehicle.
                </p>
                <p>
